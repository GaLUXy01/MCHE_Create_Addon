...
public class RadioactiveBlockItem extends BlockItem {
    public RadioactiveBlockItem(Block blockSupplier, Properties pProperties, float freqSecond, float amount, int effect_amplifier) {
        super(blockSupplier, pProperties);
