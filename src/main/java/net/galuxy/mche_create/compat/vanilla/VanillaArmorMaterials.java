...
public enum VanillaArmorMaterials implements ArmorMaterial {

    IRON("iron", 24, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON,
    ...
    VanillaArmorMaterials(String pName, int pDurabilityMultiplier, int[] pSlotProtections, int pEnchantmentValue,
